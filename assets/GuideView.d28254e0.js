import{a as _,o,b as a,f as p,i as f,H as m,w as s,e,F as d,s as g,p as w,q as v,g as c,n as y,t as b,v as S}from"./vendor.5ed81439.js";import{I as T}from"./ItemSummaryDetails.8ecafaf2.js";import{_ as H}from"./index.e5b2d6b4.js";const t=i=>(w("data-v-62dcfdf8"),i=i(),v(),i),x=t(()=>e("title",null,"Guide | AirSend",-1)),k=t(()=>e("meta",{name:"title",content:"Download and install AirSend app for Android and Windows devices"},null,-1)),I=t(()=>e("meta",{name:"description",content:"Download and install the latest version of AirSend app for Android and Windows devices on Google Play Store and Microsoft Store."},null,-1)),A=t(()=>e("meta",{name:"keywords",content:"airsend download, airsend install, airsend android, airsend windows, airsend app, clipboard sync, android, windows, share clipboard to mobile, download, easy clipboard sync"},null,-1)),C=t(()=>e("section",null,[e("h1",null,"Guide"),e("p",null,"Here you can find a general testing guide as well as troubleshooting steps if you've run into a problem")],-1)),j=t(()=>e("br",null,null,-1)),O=t(()=>e("h2",{id:"howto"},"How-to guide",-1)),D=["innerHTML"],G=["src"],N=t(()=>e("br",null,null,-1)),q=t(()=>e("br",null,null,-1)),P=t(()=>e("br",null,null,-1)),B=t(()=>e("h2",{id:"testing"},"Testing guide",-1)),M=t(()=>e("p",null," Things to do: Poke around, send messages, connect, disconnect, switch network off/on, share text to the app, paste a very long text and send, write your language's special characters, provide bad data (e.g. scan fake QR) ",-1)),Q=t(()=>e("br",null,null,-1)),R=t(()=>e("p",null," I would be very thankful if you poked around the app, tried out its functionality and gave it a hard time :). When you find some issue, please drop me a message - what happened and what steps did you take to get there. ",-1)),V=t(()=>e("br",null,null,-1)),Y=c(" Get started testing by "),L=c("downloading Airsend"),W=c("today! "),J=y('<br data-v-62dcfdf8><section data-v-62dcfdf8><h2 id="troubleshooting" data-v-62dcfdf8>Troubleshooting guide</h2><p data-v-62dcfdf8> Please write down the last steps you took and drop me a message. That will help me investigate and fix the issue. <br data-v-62dcfdf8>Now, for you to solve the issue: </p><br data-v-62dcfdf8><h3 data-v-62dcfdf8>App not responding:</h3><p data-v-62dcfdf8>Android</p><ul data-v-62dcfdf8><li data-v-62dcfdf8>Swipe up and hold (or press the rectangle button) to see all open apps. Close AirSend.</li><li data-v-62dcfdf8>Close AirSend.</li></ul><p data-v-62dcfdf8>PC</p><ul data-v-62dcfdf8><li data-v-62dcfdf8>Open Task Manager and select AirSendWPF2.exe</li><li data-v-62dcfdf8>Click &#39;End process&#39;</li></ul><br data-v-62dcfdf8><h3 data-v-62dcfdf8>Something not working right:</h3><p data-v-62dcfdf8>Click on Restart button in the app, it should be back to normal.</p><br data-v-62dcfdf8><h3 data-v-62dcfdf8>Other issue:</h3><p data-v-62dcfdf8>Please drop me a message with issue description.</p></section>',2);let F=[{q:"How to connect to a device?",a:`You want to connect from device A to device B.<br><br>
    On device B:<br>
    open AirSend<br>
...
`,ee=[JSON.parse(K),JSON.parse(X),JSON.parse(Z),JSON.parse($)];const te={data(){return{howToList:n,howToItems:ee}}},oe=Object.assign(te,{setup(i){return(u,ne)=>{const h=_("router-link");return o(),a(d,null,[p(f(m),null,{default:s(()=>[x,k,I,A]),_:1}),e("div",null,[C,j,e("section",null,[O,(o(!0),a(d,null,g(u.howToItems,l=>(o(),b(T,null,{heading:s(()=>[e("b",null,S(l.name),1)]),description:s(()=>[(o(!0),a(d,null,g(l.step,r=>(o(),a("span",null,[e("p",{innerHTML:r.text},null,8,D),e("img",{class:"img_guide_phone",src:r.image},null,8,G),N,q]))),256))]),_:2},1024))),256))]),P,e("section",null,[B,M,Q,R,V,e("p",null,[Y,p(h,{to:"downloads",title:"Download AirSend for your device"},{default:s(()=>[L]),_:1}),W])]),J])],64)}}});var de=H(oe,[["__scopeId","data-v-62dcfdf8"]]);export{de as default};
