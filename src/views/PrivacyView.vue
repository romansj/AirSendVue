...
<template>
  <Head>
    <title>Privacy Policy | AirSend</title>
  ...
  <section class="legal" id="privacy_policy">
    <h2 id="privacy_policy">CherryDev Privacy Policy</h2>

    <p>
      At AirSend app website one of our main priorities is the privacy of our visitors. This Privacy Policy
      document contains types of information that is collected and recorded by AirSend app website and how we
      use it.
    </p>
    ...
    <p>
      AirSend app website follows a standard procedure of using log files. These files log visitors when they
    ...
    <p>
      Like any other website, AirSend app website uses 'cookies'. These cookies are used to store information
    ...
    <p>
      You may consult this list to find the Privacy Policy for each of the advertising partners of AirSend app
      website.
    </p>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
      are used in their respective advertisements and links that appear on AirSend app website, which are sent
    ...
    <p>
      Note that AirSend app website has no access to or control over these cookies that are used by third-party
      advertisers.
    </p>
    ...
    <p>
      AirSend app website's Privacy Policy does not apply to other advertisers or websites. Thus, we are
      ...
      practices
      and instructions about how to opt-out of certain options. You may find a complete list of these Privacy
    ...
    <p>
      AirSend app website does not knowingly collect any Personal Identifiable Information from children under
    ...
    <p>
      ...
      regards to the information that they shared and/or collect in AirSend app website. This policy is not
      applicable to any information collected
