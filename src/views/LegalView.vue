...
<template>
  <section class="legal" id="t_and_c">
    ...
    <p>These terms and conditions outline the rules and regulations for the use of AirSend app website.</p>

    <p>
      By accessing this website we assume you accept these terms and conditions. Do not continue to use AirSend app
    ...
    <p>
      We employ the use of cookies. By accessing AirSend app website, you agreed to use cookies in agreement with the
      CherryDev's Privacy Policy.
    </p>
    ...
    <p>
      Unless otherwise stated, CherryDev and/or its licensors own the intellectual property rights for all material on
      AirSend app website. All intellectual property rights are reserved. You may access this from AirSend app website
    ...
    <p>You must not:</p>
    <ul>
      <li>Republish material from AirSend app website</li>
      <li>Sell, rent or sub-license material from AirSend app website</li>
      <li>Reproduce, duplicate or copy material from AirSend app website</li>
      <li>Redistribute content from AirSend app website</li>
    </ul>
    ...
    <p>
      ...
      areas of the website. CherryDev does not filter, edit, publish or review Comments prior to their presence on the
      website. Comments
      do not reflect the views and opinions of CherryDev,its agents and/or affiliates. Comments reflect the views and
      opinions of the person who post their views and opinions. To the extent permitted by applicable laws, CherryDev
      shall not be
    ...
    <p>
      CherryDev reserves the right to monitor all Comments and to remove any Comments which can be considered
    ...
    <p>
      You hereby grant CherryDev a non-exclusive license to use, reproduce, edit and authorize others to use,
    ...
    <p>
      ...
      benefit to us from the visibility of the hyperlink compensates the absence of CherryDev; and (d) the link is in
    ...
    <p>
      ...
      you must inform us by sending an e-mail to CherryDev. Please include your name, your organization name, contact
      information as well
      as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs
    ...
    <p>No use of CherryDev's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
